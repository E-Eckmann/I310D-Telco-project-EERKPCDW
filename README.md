...
Unsupervised ML project.ipynb is a supplementary K-means clustering model that clusters entries into four tiers of risk based on their associated 'probability' field generated by the Supervised ML model

To use this project, you must download the .ipynb and .CSV files of the dataset we posted on Data.world and then upload these files into your chosen coding environment
